...
if practicemode == 1
    ...
    expt.words = {
        % SW Nouns
        'bishop' 'boredom' 'chaos' 'custom' 'essence' ...
        'fury' 'hatred' 'impulse' 'instinct' 'maker' ...
        'mercy' 'motive' 'nonsense' 'outcome' 'outset' ...
        'patience' 'rating' 'folly' 'token' 'treaty' ...
        % WS Nouns
        'abyss' 'advice' 'affair' 'antique' 'belief' ...
        'bequest' 'buffoon' 'cuisine' 'deceit' 'event' ...
        'expanse' 'extent' 'monsoon' 'prestige' 'receipt' ...
        'renown' 'response' 'revenge' 'routine' 'typhoon' ...
        % SW Verbs
        'alter' 'argue' 'bury' 'carry' 'lessen' ...
        'listen' 'manage' 'marry' 'peddle' 'perish' ...
        'prosper' 'punish' 'quicken' 'sever' 'startle' ...
        'stifle' 'strengthen' 'vary' 'wander' 'wonder'...
        % WS Verbs
        'amuse' 'arise' 'attend' 'await' 'condemn' ...
        'depict' 'describe' 'despise' 'destroy' 'erupt' ...
        'expose' 'express' 'forbid' 'ignore' 'improve' ...
        'induce' 'offend' 'portray' 'retain' 'succeed'};
